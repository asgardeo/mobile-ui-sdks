...
extra.apply {
    set("artifactId", properties["MAIN_PACKAGE_NAME"].toString()+"-core-auth-direct")
    set("artifactName", "core-auth-direct")
    set(
        "artifactDescription",
        "A package that provides all the core functionalities to implement direct authentication for Android tools with Asgardeo."
    )
    set("versionNumber", properties["CORE_AUTH_DIRECT_VERSION"])
}
